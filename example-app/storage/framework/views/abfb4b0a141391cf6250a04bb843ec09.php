...
<body>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="<?php echo e(route('xu-li-dang-ki')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <h3><b>Đăng Ký</b></h3>
                <span>Sử dụng email của bạn để đăng ký</span>
                <input type="text" name="hovaten" placeholder="Họ và tên" />
                <div class="error-message"><?php echo e($errors->first('hovaten')); ?></div>

                <input type="text" name="sdt" placeholder="Số điện thoại" />
                <div class="error-message"><?php echo e($errors->first('sdt')); ?></div>
        ...
        <div class="form-container sign-in-container">
            <form action="<?php echo e(route('xu-li-dang-nhap')); ?>" method="post" id="form-login">
                <?php echo csrf_field(); ?>
                <h3><b>Đăng Nhập</b></h3>
...
<?php /**PATH C:\Users\ADMIN\Desktop\DATN\example-app-2\resources\views/login.blade.php ENDPATH**/ ?>