<?php $__env->startSection('title', 'Thêm đơn hàng | Quản trị viên'); ?>
    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(url('/them-don-hang')); ?>">Thêm đơn hàng</a></li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
...
<?php echo $__env->make('layout.master_ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\DATN\example-app\resources\views/admin/them-don-hang.blade.php ENDPATH**/ ?>