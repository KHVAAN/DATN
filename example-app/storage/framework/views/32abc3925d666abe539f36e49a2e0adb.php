        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Thêm sản phẩm</a>
                        <a class="collapse-item" href="">Danh sách sản
                            phẩm</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Cấu hình sản phẩm:</h6>
                        <a class="collapse-item" href="">Màu</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="">Đơn hàng mới</a>
                        <a class="collapse-item" href="">Đơn hàng
                            đang giao</a>
                        <div class="collapse-divider"></div>
                        <a class="collapse-item" href="">Đơn hàng
                            hoàn tất</a>
                        <a class="collapse-item" href="">Đơn hàng
                            hoàn trả</a>
                        <a class="collapse-item" href="">Đơn hàng hủy</a>
                    </div>
                </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                <?php
$name = session('name'); ?> data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                ...
                                <?php else: ?>
                                    <img class="img-profile rounded-circle" src="<?php echo e($avatar); ?>">
                                <?php endif; ?>
                            </a>
...
<?php echo $__env->yieldContent('scr'); ?>

</html>
<?php /**PATH C:\Users\ADMIN\Desktop\example-app\resources\views/admin/index.blade.php ENDPATH**/ ?>