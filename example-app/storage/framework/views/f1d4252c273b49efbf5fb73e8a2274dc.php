                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-dark mb-2" href="<?php echo e(url('/')); ?>"><i class="fa fa-angle-right mr-2"></i>Trang Chủ</a>
                            <a class="text-dark mb-2" href="<?php echo e(url('/shop')); ?>"><i class="fa fa-angle-right mr-2"></i>Tất cả</a>
                            <a class="text-dark mb-2" href="<?php echo e(url('/detail')); ?>"><i class="fa fa-angle-right mr-2"></i>Sản Phẩm</a>
                            <a class="text-dark mb-2" href="<?php echo e(url('/cart')); ?>"><i class="fa fa-angle-right mr-2"></i>Giỏ Hàng</a>
                            <a class="text-dark mb-2" href="<?php echo e(url('/checkout')); ?>"><i class="fa fa-angle-right mr-2"></i>Thanh Toán</a>
                            <a class="text-dark" href="<?php echo e(url('/contact')); ?>"><i class="fa fa-angle-right mr-2"></i>Liên Hệ</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
                        <h5 class="font-weight-bold text-dark mb-4">CSKH</h5>
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-dark mb-2" href=""><i class="fa fa-angle-right mr-2"></i>Vận chuyển</a>
                            ...
                            <a class="text-dark mb-2" href=""><i class="fa fa-angle-right mr-2"></i>Khách hàng VIP</a>
                            <a class="text-dark mb-2" href=""><i class="fa fa-angle-right mr-2"></i>Đối tác cung cấp</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
                        <h5 class="font-weight-bold text-dark mb-4">Phản Hồi Ý Kiến</h5>
                        <form action="">
...
<?php /**PATH C:\Users\ADMIN\Desktop\DATN\example-app-2\resources\views/layout/footer.blade.php ENDPATH**/ ?>