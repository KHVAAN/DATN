                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        <?php if(Auth::check()): ?>
                            <div class="nav-item nav-link user-menu">
                             ...
                             document.getElementById('logout-form').submit();">
                                    ...
                                    <form id="logout-form" action="<?php echo e(route('dang-xuat')); ?>" method="POST"
                                        style="display: none;">
                                        <?php echo csrf_field(); ?>
                                    </form>
                                </div>
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('dang-ki')); ?>" class="nav-item nav-link">Đăng ký</a>
                        <?php endif; ?>
                    </div>
                </div>
            </nav>
...
<!-- Navbar End -->
<?php /**PATH C:\Users\ADMIN\Desktop\DATN\example-app\resources\views/layout/header.blade.php ENDPATH**/ ?>