    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item active"><a href="<?php echo e(url('/quan-li-nhan-vien')); ?>"><b>Danh sách nhân viên</b></a>
                </li>
            </ul>
            <div id="clock"></div>
        </div>
                    ...
                    <div class="tile-body">
                        ...
                        <div class="row element-button">
                            <div class="col-sm-2">
                                ...
                                <a class="btn btn-add btn-sm" href="<?php echo e(url('/them-nhan-vien')); ?>" title="Thêm"><i
                                        class="fas fa-plus"></i>
                                    Tạo mới nhân viên</a>
                            </div>
                            <div class="col-sm-2">
...
<?php echo $__env->make('layout.master_ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\example-app-2\resources\views/admin/quan-li-nhan-vien.blade.php ENDPATH**/ ?>