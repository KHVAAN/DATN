<?php $__env->startSection('title', 'Thêm quản trị viên | Quản trị viên'); ?>
    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('quan-li-nhan-vien')); ?>">Danh sách quản trị viên</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form class="row" action="<?php echo e(route('xu-li-them-admin')); ?>" method="POST"
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <a class="btn btn-cancel" href="<?php echo e(route('quan-li-nhan-vien')); ?>">Hủy bỏ</a>
                            </div>
                    </div>
                    </form>
                </div>
...
<?php echo $__env->make('layout.master_ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\DATN\example-app\resources\views/admin/them-admin.blade.php ENDPATH**/ ?>