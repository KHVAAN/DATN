...
<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
    <div class="row justify-content-center px-xl-5 pt-5">
        <div class="col-lg-5 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                        class="text-primary font-weight-bold border border-white px-3 mr-1">E</span>StyleVista</h1>
            </a>
            <p>Chất lượng và phong cách là chìa khóa của chúng tôi. Khám phá thế giới thời trang tại cửa hàng của chúng
                tôi ngay hôm nay.</p>
            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>65 Huỳnh Thúc Kháng, Quận 1, TP. Hồ
                Chí Minh</p>
        ...
        <div class="col-lg-5 col-md-12">
            <div class="row">
                <div class="col-md-6 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-dark mb-2" href="{{ url('/') }}"><i class="fa fa-angle-right mr-2"></i>Trang
                            Chủ</a>
                        <a class="text-dark mb-2" href="{{ url('/shop') }}"><i class="fa fa-angle-right mr-2"></i>Sản
                            Phẩm</a>
                        <a class="text-dark mb-2" href="{{ url('/intro') }}"><i class="fa fa-angle-right mr-2"></i>Giới
                            Thiệu</a>
                        <a class="text-dark" href="{{ url('/contact') }}"><i class="fa fa-angle-right mr-2"></i>Liên
                            Hệ</a>
                    </div>
                </div>
                <div class="col-md-6 mb-5">
                ...
                {{-- <div class="col-md-4 mb-5">
                    <h5 class="font-weight-bold text-dark mb-4">Đối Tác Cung Cấp</h5>
