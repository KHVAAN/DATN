                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-dark mb-2" href="<?php echo e(url('/shop')); ?>"><i class="fa fa-angle-right mr-2"></i>Sản Phẩm</a>
                            <a class="text-dark mb-2" href="<?php echo e(url('/intro')); ?>"><i class="fa fa-angle-right mr-2"></i>Giới Thiệu</a>
