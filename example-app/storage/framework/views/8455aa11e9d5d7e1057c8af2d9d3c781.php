...
<body onload="time()" class="app sidebar-mini rtl">
    <?php echo $__env->make('layout.header_ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            $('.trash').click(function() {
                var id = $(this).data('id');
                var url = "<?php echo e(url('/xoa-nhan-hieu')); ?>" + '/' + id;
...
<?php /**PATH C:\Users\ADMIN\Desktop\DATN\example-app\resources\views/layout/master_ad.blade.php ENDPATH**/ ?>