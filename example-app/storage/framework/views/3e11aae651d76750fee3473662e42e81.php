                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle"><img src="img/product-1.jpg" alt="" style="width: 50px;">
                                Tên sản phẩm</td>
                            <td class="align-middle">Giá đ</td>
                            ...
                            <td class="align-middle">Giá tổng đ</td>
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            <h5 class="font-weight-bold">Tổn thanh toán</h5>
                            <h5 class="font-weight-bold">Giá đ</h5>
                        </div>
                        <button class="btn btn-block btn-primary my-3 py-3">Tiếp Tục Thanh Toán</button>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\DATN\example-app\resources\views/user/cart.blade.php ENDPATH**/ ?>